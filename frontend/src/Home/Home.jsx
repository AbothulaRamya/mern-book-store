...
export default function Home() {
  ...
  function submitBook(e) {
    ...
    try {
      ...
      const updateBook = { ...editBook, userId }
      axios.put(`http://localhost:5000/api/book/books/${editBook._id}`, updateBook)
        .then((res) => {
          if (res.status === 200) {
      ...
      console.log(error)
      if (error.status === 403) {
        alert("You have not authorised to update this book")
        setEditBook(null)
      }
    }
                      ...
                      <div className='col' key={book._id}>
                        <div className="card h-100">
                          ...
                          <div class="card-footer">
                            ...
                            <button onClick={() => deleteBook(book._id)} className="btn btn-danger fw-bold float-end">Delete</button>
                          </div>
                        </div>
